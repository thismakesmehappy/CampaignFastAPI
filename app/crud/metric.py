...
async def create_metric(db: AsyncSession, campaign_id: int, data: MetricBase) -> Metric:
...
async def update_metric(db: AsyncSession, metric_id: int, data: MetricBase) -> Metric | None:
